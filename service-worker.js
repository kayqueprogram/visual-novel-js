	...
	event.respondWith (
		caches.match (event.request).then ((cached) => {
			...
			function unableToResolve () {
				return new Response (`
					<!DOCTYPE html><html lang=en><title>Indisponível</title><meta charset=UTF-8><meta content="width=device-width,initial-scale=1"name=viewport><style>body,html{width:100%;height:100%}body{text-align:center;color:#545454;margin:0;display:flex;justify-content:center;align-items:center;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen,Ubuntu,Cantarell,"Open Sans","Fira Sans","Droid Sans","Helvetica Neue",sans-serif}h1,h2{font-weight:lighter}h1{font-size:4em}h2{font-size:2em}</style><div><h1>Serviço não disponível</h1><h2>Desculpe, o servidor está indisponível no momento ou em manutenção, tente novamente mais tarde.</h2></div>
				`, {
					status: 503,
